...
export default function NavBar({ bgColor }) {
    ...
    const handlePortfolioNav = () => {
        window.location.hash = "/myPortfolio";
    };
    ...
    return (
        <>
            <div className="fixed top-0 left-0 z-100 w-full">
                <nav
                    className="flex items-center h-[6rem] pl-6 lg:pl-10 justify-between pr-[10%] lg:pr-[17%]"
                ...
                >
                    <div className="flex items-center">
                        <svg
                            ...
                            className="fill-transparent stroke-white w-[2rem] h-[2rem] lg:w-[3rem] lg:h-[3rem] lg:ml-[3rem]"
                            width="28"
                            height="28"
                            viewBox="0 0 28 28"
                        >
                        ...
                        <span className="inline-block ml-4 text-xl lg:text-2xl text-white">
                            {"<Dullarzee/>"}
                        </span>
                    </div>
                            ...
                            <ul className="flex flex-col gap-y-[2rem] mt-[5rem] *:cursor-pointer">
                                <li
                                    ...
                                    className={
                                        window.location.hash === "#/home" ||
                                        window.location.hash === ""
                                            ? "text-sky-500 text-2xl text-bold cursor-pointer border-r-4 border-sky-500"
                                            : "text-slate-700 text-lg font-inter cursor-pointer"
                                    }
                                >
                                    Home
                                </li>
