        ...
        <>
         <div className="bg-gradient-to-br from-blue-950 to-blue-500">
            <div className="min-h-[100vh] bg-[url(/images/pattern-lines.svg),url(/images/pattern-circle.svg)] bg-[85%,20%,auto,auto] bg-no-repeat">
                ...
                mx-auto mt-[3%]">
                    <div className="pt-[15%]">
                        ...
                        <div className="flex flex-col lg:flex-row gap-y-[1rem] lg:gap-y-0 lg:gap-x-[5%] mt-[6%]">
                            ...
                            duration-200 stroke-white ml-[0.5rem]" height="12" xmlns="http://www.w3.org/2000/svg"><path d="M34.05 0l5.481 5.527h.008v.008L40 6l-.461.465v.063l-.062-.001L34.049 12l-.662-.668 4.765-4.805H0v-1h38.206l-4.82-4.86L34.05 0z" fill="#000" fillRule="nonzero"/></svg>
                            </a></button>
                        </div>
                    ...
                    <div className="flex lg:rotate-90 w-[21rem] absolute top-[58%] left-[0%] lg:top-[50%] lg:left-[90%] items-center">
                        ...
                        <svg width="40" className="stroke-white ml-[0.5rem]" height="12" xmlns="http://www.w3.org/2000/svg"><path d="M34.05 0l5.481 5.527h.008v.008L40 6l-.461.465v.063l-.062-.001L34.049 12l-.662-.668 4.765-4.805H0v-1h38.206l-4.82-4.86L34.05 0z" fill="#000" fillRule="nonzero"/></svg>
                        <div className="flex w-[8rem] gap-x-[0.7rem] ml-[0.5rem]">
                            <a className="-rotate-90" href="https://www.linkedin.com/in/oluwatimilehin-samuel-27592727a" target="_blank">
                            ...
                            <a className="-rotate-90" href="https://web.facebook.com/profile.php?id=100087108926104">
                            ...
                            <a className="-rotate-90" href="https://github.com/dullarzee">
                                <svg className="fill-white hover:fill-red-400" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                ...
                <section className="grid grid-cols-1 gap-y-[4%] lg:gap-y-0 lg:grid-cols-3 w-[85%] lg:gap-x-[3%] mx-auto my-40 mb-15
                *:rounded-md">
                    <motion.div initial={{opacity:0, y:50}}
                                whileInView={{opacity:1, y:0}}
                                transition={{duration:0.5}} className="bg-blue-800 p-[7%]">
                    ...
                    <motion.div initial={{opacity:0, y:70}}
                                whileInView={{opacity:1, y:0}}
                                transition={{duration:0.9}} className="bg-blue-800 p-[7%]">
                        <div className="flex flex-col space-y-[0.5rem]">
                    ...
                    <motion.div initial={{opacity:0, y:90}}
                                whileInView={{opacity:1, y:0}}
                                transition={{duration:1.1}} className="bg-blue-800 p-[7%]">
                        <div className="flex flex-col space-y-[0.5rem]">
