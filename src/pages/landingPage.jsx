        ...
        <>
         <div className="bg-gradient-to-br from-blue-950 to-blue-500">
            <div className="min-h-[100vh] bg-[url(/images/pattern-lines.svg),url(images/pattern-circle.svg)] bg-[85%,20%,auto,auto] bg-no-repeat">
                ...
                <section className="relative grid grid-cols-1 lg:grid-cols-2 space-y-[5rem] lg:space-y-0 w-[85%] 
                mx-auto mt-[3%]">
                    <div className="pt-[15%]">
                        <h1 className="text-sky-600 text-xl font-semibold">Welcome to my Portfolio!</h1>
                        <h2 className="text-7xl font-inter font-semibold text-white leading-[120%] my-[1rem]">
                            Hello, my name's <span className="text-sky-500">Timmy</span>.
                        </h2>
                        <p className="text-lg text-slate-200 font-karla lg:pr-[30%]">
                            I'm a frontend developer, aspiring fullstack developer and know C & C++ and based in Lagos, Nigeria
                        </p>
                        ...
                        <div className="flex flex-col lg:flex-row gap-y-[1rem] lg:gap-y-0 lg:gap-x-[5%] mt-[6%]">
                            ...
                            <button className=""><a href="#/myPortfolio" className="flex items-center justify-center px-[1.8rem] py-2.5 text-white 
                            group cursor-pointer font-semibold text-md rounded-full border-2 border-white 
                            hover:bg-white hover:text-sky-500">See my work 
                            <svg width="40" className="group-hover:translate-x-[1rem] group-hover:stroke-sky-500 transition-transform
                            duration-200 stroke-white ml-[0.5rem]" height="12" xmlns="http://www.w3.org/2000/svg"><path d="M34.05 0l5.481 5.527h.008v.008L40 6l-.461.465v.063l-.062-.001L34.049 12l-.662-.668 4.765-4.805H0v-1h38.206l-4.82-4.86L34.05 0z" fill="#000" fill-rule="nonzero"/></svg>
                            </a></button>
                        </div>

                    </div>
                    <div className="flex items-center justify-end pr-[10%] mt-[5rem]">
                        <div className="outline-2 outline-white/30 outline-offset-[3rem] rounded-full">
                            <img alt='my photo' className="h-[20rem] lg:h-[35rem] border-4 border-sky-600 outline-2 outline-sky-300 outline-offset-[1.5rem] rounded-full bg-blend-multiply" src="/images/VVFQE9780.JPG"></img>
                            
                        </div>

                    </div>
                    <div className="flex lg:rotate-90 w-[21rem] absolute top-[58%] left-[0%] lg:top-[50%] lg:left-[90%] items-center">
                        <span className="shrink-0 text-slate-200 text-lg">FOLLOW ME ON </span>
                        <svg width="40" className="stroke-white ml-[0.5rem]" height="12" xmlns="http://www.w3.org/2000/svg"><path d="M34.05 0l5.481 5.527h.008v.008L40 6l-.461.465v.063l-.062-.001L34.049 12l-.662-.668 4.765-4.805H0v-1h38.206l-4.82-4.86L34.05 0z" fill="#000" fill-rule="nonzero"/></svg>
                        <div className="flex w-[8rem] gap-x-[0.7rem] ml-[0.5rem] lg:*:-rotate-90">
                            <a href="https://www.linkedin.com/in/oluwatimilehin-samuel-27592727a" target="_blank">
                                <svg version="1.1" className="fill-white hover:fill-red-400" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                    <path d="M29 0h-26c-1.65 0-3 1.35-3 3v26c0 1.65 1.35 3 3 3h26c1.65 0 3-1.35 3-3v-26c0-1.65-1.35-3-3-3zM12 26h-4v-14h4v14zM10 10c-1.106 0-2-0.894-2-2s0.894-2 2-2c1.106 0 2 0.894 2 2s-0.894 2-2 2zM26 26h-4v-8c0-1.106-0.894-2-2-2s-2 0.894-2 2v8h-4v-14h4v2.481c0.825-1.131 2.087-2.481 3.5-2.481 2.488 0 4.5 2.238 4.5 5v9z"></path>
                                </svg>
                            </a>
                            <a href="https://web.facebook.com/profile.php?id=100087108926104">
                                <svg className="fill-white hover:fill-red-400" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                    <path d="M29 0h-26c-1.65 0-3 1.35-3 3v26c0 1.65 1.35 3 3 3h13v-14h-4v-4h4v-2c0-3.306 2.694-6 6-6h4v4h-4c-1.1 0-2 0.9-2 2v2h6l-1 4h-5v14h9c1.65 0 3-1.35 3-3v-26c0-1.65-1.35-3-3-3z"></path>
                                </svg>
                            </a>   
                            <a href="https://github.com/dullarzee">
                                <svg className="fill-white hover:fill-red-400" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                ...
                <div className="flex mx-auto w-[85%] gap-x-[0.7rem] items-center">
                    <div className="flex items-center outline-2 outline-white/30 h-[3rem] w-[3rem] rounded-full bg-blue-950">
                        <svg className="fill-white stroke-transparent ml-[8%]" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                    ...
                    <span className="font-semibold text-white/50 cursor-default">Scroll down</span>
                </div>


                <section className="grid grid-cols-1 space-y-[4%] lg:space-y-0 lg:grid-cols-3 w-[85%] gap-x-[3%] mx-auto my-40 mb-15 *:p-[7%]
                *:bg-blue-800 *:rounded-md">
                    <motion.div initial={{opacity:0, y:50}}
                                whileInView={{opacity:1, y:0}}
                                transition={{duration:0.5}} className="flex flex-col space-y-[0.5rem]">
                        <svg className="stroke-sky-500 fill-blue-500" version="1.1" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                        ...
                        <p className="pr-[7%] text-slate-300/80 font-karla">
                            I have a passion for Computer Science that is not in anyway forced...it is evident in how short a 
                            time i used to become an intermediate frontend Developer 
                        </p>

                    </motion.div>
                    <motion.div initial={{opacity:0, y:70}}
                                whileInView={{opacity:1, y:0}}
                                transition={{duration:0.9}} className="flex flex-col space-y-[0.5rem]">
                        <svg className="fill-white" version="1.1" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24">
                        ...
                        <p className="pr-[7%] text-slate-300/80 font-karla">
                            After God, my next best craving is programming...For the right price, Nothing
                            is impossible!
                        </p>
                    ...
                    <motion.div initial={{opacity:0, y:90}}
                                whileInView={{opacity:1, y:0}}
                                transition={{duration:1.1}} className="flex flex-col space-y-[0.5rem]">
                        <svg className="fill-white" version="1.1" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 32 32">
                        ...
                        <p className="pr-[7%] text-slate-300/80 font-karla">
                            I dont have to be an artist to be a creative developer also I believe in team power
