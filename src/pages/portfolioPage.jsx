...
export default function PortfolioPage(){
   ...
   const array = [];
    data.map(it=>{
        array.push(<ProjectCard heading={it.heading} mainImage={it.mainImage} link={it.link} type={it.type}
            description={it.description} />)
    })
    return(
        <>
         <div 
         className="bg-gradient-to-bl from-blue-400 to-blue-900 min-h-[100vh] pb-[20%]">
            <NavBar />
